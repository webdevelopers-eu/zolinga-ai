...
```html
<ai-text capabilities="fast" remove-invalid-links="true">
...
```html
<ai-text capabilities="default" uuid="homepage-hero">
...
- **`capabilities`**: The required capability or array of capabilities. The best-matching backend is selected automatically.
  - Optional
  - Default: "default"
...
- **`capabilities-meta`**: The capability to use for metadata generation.
  - Optional
  - Default: same as `capabilities` or "default"
...
```html
<ai-text capabilities="creative" uuid="brand-article-acme">
  <step>
...
```html
<ai-text capabilities="creative" uuid="brand-article-acme-seed">
  <step>
    Write a blog post about trademark monitoring for ACME.
...
```html
<ai-text capabilities="default" uuid="demo:prompt-variation">
  <step>
...
```html
<ai-text capabilities="default" remove-invalid-links="true">
...
```html
<ai-text capabilities="premium" element="section" class="premium-content featured" data-analytics="ai-generated">
...
```html
<ai-text capabilities="creative" uuid="homepage-intro-2025">
...
```html
<ai-text capabilities="default" uuid="seo-article-example" show-meta="title,description,tldr" capabilities-meta="default">
